...
namespace WPMF {
	public class Country: IAdminEntity {
        ...
        #region  country parameters
		//MAX!

        // The 7 basic parameters of the game
        public RegionData data;

		// List of neighboring countries
		public List<int> countryNeighborIndices;
        #endregion
		...
		public Country Clone() {
            ...
            #region  clone country parameters
            // Cloning the basic parameters
            c.data.clone(data);
			c.countryNeighborIndices = new List<int>(countryNeighborIndices);
            #endregion
