		...
		public override void OnInspectorGUI ()
		{
			...
			if (_decorator.GUICountryName.Length > 0) {
				...
				if (!decorator.hidden) {
					...
					if (prevColorized!=decorator.isColorized) requestChanges = true;
					if (decorator.isColorized) {
						...
						if (prevIncludeAllRegions!=decorator.includeAllRegions) requestChanges = true;
						EditorGUILayout.EndHorizontal ();
						...
						if (decorator.texture != null) {
							...
							if (prevIncludeAllRegions!=decorator.applyTextureToAllRegions) requestChanges = true;
							EditorGUILayout.EndHorizontal ();
							EditorGUILayout.BeginHorizontal ();
